...
import type { Form } from '../song/CalculatorV2.vue';
import RankChange from './RankChange.vue';
import Calculator from '../song/CalculatorV2.vue';
import RankItem from './RankItem.vue';
import { DateTime } from 'luxon';
import { compareRank } from '@/utils/dataConverter';
import { ElDialog } from 'element-plus';
import RankingDialog from './RankingDialogV2.vue';
...
import type Board from '@/utils/boardv2';
